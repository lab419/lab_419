...
- 5、[MMD-MA](#MMD-MA):无监督流形对齐算法（输入embedding输出距离）
...
#### <span id="MMD-MA">MMD-MA:</span>
- 简易使用：
```
python manifoldAlignDistortionPen_mmd_multipleStarts.py X_linearkernel.tsv Y_linearkernel.tsv --l1 1e-6 --l2 1e-2 --p 5 --bandwidth 0.5 --seed 50
```
- 支持文档：
